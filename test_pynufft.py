...
argv = sys.argv[1:]
try:
	opts, args = getopt.getopt(argv, "hk:j:o:t:g:", ["Kd=", "Jd=", "om_path=", "title=", "gpu="])
except getopt.GetoptError:
	print('test.py -k <kspaceSize> -j <kernelSize> -o <omPath> -t <title> -g <gpu>')
	sys.exit(2)
for opt, arg in opts:
	if opt == '-h':
		print('test.py -k <kspaceSize> -j <kernelSize> -o <omPath> -t <title> -g <gpu>')
...
img_reconstruct = NufftObj.adjoint(y_pynufft)
